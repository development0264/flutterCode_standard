...
public class AnswerJavaActivity extends AppCompatActivity {
    ...
    private final BroadcastReceiver callRejectReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            Log.e(TAG, "Receiving events for reject -----> " + intent.getAction());
            if (intent.getAction().equals("ACTIVITY_CALL_REJECT")) {
    ...
    private final BroadcastReceiver callAcceptReceiver = new BroadcastReceiver() {
        @Override
        public void onReceive(Context context, Intent intent) {
            Log.e(TAG, "Receiving accept events for reject -----> " + intent.getAction());
            if (intent.getAction().equals("ACTIVITY_CALL_ACCEPT")) {
    ...
    private void acceptCall() {
        ...
        Log.e(TAG, "Clicked accept startService");
    ...
    protected void onResume() {
        LocalBroadcastManager.getInstance(this).registerReceiver(
                callRejectReceiver, new IntentFilter("ACTIVITY_CALL_REJECT"));

        LocalBroadcastManager.getInstance(this).registerReceiver(
                callAcceptReceiver, new IntentFilter("ACTIVITY_CALL_ACCEPT"));
        super.onResume();
    }
