...
class ApiProvider {
  ...
  static String baseUrl = FlavorConfig.instance.flavorValues.baseUrl;
  ...
  static Future<dynamic> postAsync(String urlEndpoint,
      {Map<String, String> headersNew, dynamic body}) async {
    headers.putIfAbsent('Content-type', () => 'application/json');
    var responseData;
    if (headersNew != null) headers.addAll(headersNew);
    try {
  ...
  static Future<dynamic> putAsync(String urlEndpoint,
      {Map<String, String> headersNew, dynamic body}) async {
    headers.putIfAbsent('Content-type', () => 'application/json');
    var responseData;
    if (headersNew != null) headers.addAll(headersNew);
  ...
  static Future<dynamic> patchAsync(String urlEndpoint,
      {Map<String, String> headersNew, dynamic body}) async {
    headers.putIfAbsent('Content-type', () => 'application/json');
    var responseData;
    if (headersNew != null) headers.addAll(headersNew);
