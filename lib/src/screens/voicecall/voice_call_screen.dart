...
class _VoiceCallScreenState extends State<VoiceCallScreen> {
  ...
  void listenCall() {
    callStateListener = TwilioVoice.instance.callEventsListener.listen((event) {
      print("CURRENT PAGE EVENT --> $event");
  ...
  String getCaller() {
    ...
    if (activeCall != null) {
      return activeCall.callDirection == CallDirection.outgoing ? activeCall.toFormatted : activeCall.fromFormatted;
    }
    return "Unknown";
  }
                  ...
                  Row(mainAxisAlignment: MainAxisAlignment.spaceAround, children: [
                    Material(
                      ...
                      child: Ink(
                        decoration: BoxDecoration(
                          ...
                          color: speaker ? Theme.of(context).primaryColor : Colors.white24,
                    ...
                    Material(
                      ...
                      child: Ink(
                        decoration: BoxDecoration(
                          border: Border.all(color: Colors.white, width: 1.0),
                          color: mute ? Theme.of(context).accentColor : Colors.white24,
                          shape: BoxShape.circle,
                        ),
                        child: InkWell(
                          //This keeps the splash effect within the circle
