...
class FormBuilderValidators {
  ...
  static FormFieldValidator<T> equal<T>(
    ...
    String errorText,
      ...
      (valueCandidate) =>
          valueCandidate != value ? errorText ?? FormBuilderLocalizations.of(context).equalErrorText(value) : null;
  ...
  static FormFieldValidator<T> notEqual<T>(
    ...
    String errorText,
      ...
      (valueCandidate) =>
          valueCandidate == value ? errorText ?? FormBuilderLocalizations.of(context).notEqualErrorText(value) : null;
  ...
  static FormFieldValidator<String> creditCard(
    ...
    String errorText,
      ...
      (valueCandidate) => true == valueCandidate?.isNotEmpty && !isCreditCard(valueCandidate)
          ? errorText ?? FormBuilderLocalizations.of(context).creditCardErrorText
          : null;
  ...
  /// [FormFieldValidator] that requires the field's value to be a validate the start and the end date.
  static FormFieldValidator<dynamic> dateMatcher(
    BuildContext context,
    DateTime startDate,
    DateTime endDate, {
    String errorText,
  }) =>
      (valueCandidate) => startDate != null && endDate != null && startDate.isAfter(endDate)
          ? errorText ?? FormBuilderLocalizations.of(context).dateStringErrorText
          : null;
}
