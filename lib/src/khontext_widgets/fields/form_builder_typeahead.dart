...
class FormBuilderTypeAhead<T> extends FormBuilderField<T> {
  ...
  /// Controls the text being changed in the text field used.
  ///
  /// It will give events of the text changed or typed by the user in the type ahead.
            ...
            return TypeAheadField<T>(
              ...
              onSuggestionSelected: (T suggestion) {
                if (selectionToTextTransformer != null) {
                  controller.text = selectionToTextTransformer(suggestion);
                } else {
                  controller.text = suggestion != null ? suggestion.toString() : '';
                }
