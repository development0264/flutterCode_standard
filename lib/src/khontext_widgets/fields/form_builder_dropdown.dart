                  ...
                  Expanded(
                    child: DropdownButtonHideUnderline(
                      child: DropdownButton<T>(
                        ...
                        hint: hint,
                        items: items,
                        value: state.value == null && state.initialValue != null ? state.initialValue : field.value,
                        style: style,
                        isDense: isDense,
                        disabledHint: field.value != null
                            ? (items.firstWhere((val) => val.value == field.value, orElse: () => null)?.child ??
                        ...
                        onChanged: state.enabled ? (value) => changeValue(value) : null,
                        onTap: onTap,
...
class _FormBuilderDropdownState<T> extends FormBuilderFieldState<FormBuilderDropdown<T>, T> {}
