...
class _FormBuilderTextFieldState extends FormBuilderFieldState<FormBuilderTextField, String> {
  ...
  void initState() {
    super.initState();
    _controller = widget.controller ?? TextEditingController(text: initialValue);
