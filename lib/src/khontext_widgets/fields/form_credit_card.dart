...
class CreditCardForm extends StatefulWidget {
  const CreditCardForm(
      ...
      this.isCardNumberEnabled = true,
      this.isCvvEnabled = true})
      : super(key: key);
  ...
  final bool isCardNumberEnabled;
  final bool isCvvEnabled;
...
class _CreditCardFormState extends State<CreditCardForm> {
  ...
  void initState() {
    ...
    List<String> dateList = widget.expiryDate?.split('/');
    if (dateList != null && dateList.isNotEmpty && dateList.length > 1) {
      dateList[1] = dateList[1].substring(dateList[1].length - 2);
    }
    _expiryDateController.text = dateList.join('/');
          ...
          children: <Widget>[
            Container(
              ...
              child: TextFormField(
                ...
                enabled: widget.isCardNumberEnabled,
                style: TextStyle(
