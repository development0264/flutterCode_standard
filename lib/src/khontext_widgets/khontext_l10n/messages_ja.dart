...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "signInTitleText":MessageLookupByLibrary.simpleMessage("サインインして仕事に取り掛かる"),
    "userNameHintText":MessageLookupByLibrary.simpleMessage("ユーザー名、電話または電子メール"),
    "passwordHintText":MessageLookupByLibrary.simpleMessage("パスワード"),
    "continueBtnText":MessageLookupByLibrary.simpleMessage("継続する"),
    "noAccountText":MessageLookupByLibrary.simpleMessage("アカウントをまだお持ちではありませんか？"),
    "signUpText":MessageLookupByLibrary.simpleMessage("サインアップ"),
  };
}
