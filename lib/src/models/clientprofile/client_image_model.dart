...
ClientProfileImageResponseModel clientProfileImageResponseModelFromJson(String str) =>
    ClientProfileImageResponseModel.fromJson(json.decode(str));

String clientProfileImageResponseModelToJson(ClientProfileImageResponseModel data) => json.encode(data.toJson());

class ClientProfileImageResponseModel {
  ClientProfileImageResponseModel({
    @required this.data,
  ...
  ClientProfileImageData data;
  String message;
  dynamic errors;
  bool isSuccessful;

  factory ClientProfileImageResponseModel.fromJson(Map<String, dynamic> json) => ClientProfileImageResponseModel(
        data: json["data"] == null ? null : ClientProfileImageData.fromJson(json["data"]),
...
class ClientProfileImageData {
  ClientProfileImageData({
  ...
  factory ClientProfileImageData.fromJson(Map<String, dynamic> json) => ClientProfileImageData(
